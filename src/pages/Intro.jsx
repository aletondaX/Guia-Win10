    ...
    <div className="container">
      ...
      <div className="main-container">
        <main>
          ...
          <h2>El Problema</h2>
          <p>Con cada lanzamiento de una nueva versión de Windows, el SO se volvió cada vez más intrusivo/invasivo para el usuario. Esto se traduce básicamente en dos cosas:</p>
          <ul>
          ...
          <p>En pocas palabras, las soluciones antivirus y el performance son por lo general dos cosas mutuamente exclusivas. Y además de ser incompatibles con el performance, en muchos casos son intrusivas, al punto en que su perjuicio termina siendo mucho mayor a su supuesto beneficio.</p>
