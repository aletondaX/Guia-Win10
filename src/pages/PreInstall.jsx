    ...
    <div className="container">
      ...
      <div className="main-container">
        <main>
          ...
          <br />
          <p>Descargar el archivo <a href="downloads/NTLite - Integrar Alto Rendimiento.reg" download onClick={() => setCheck(2)}>.reg</a> que vamos a integrar a nuestra ISO. {checks[2] ? <img className="img-ok" src="ok.png"/> : <></>}</p>
          <br />
          ...
          <p>Descargar <a href="downloads/Accesos Directos.7z" download onClick={()=>setCheck(4)}>Accesos Directos</a>. {checks[4]?<img className="img-ok" src="ok.png"/>:<></>}</p>
