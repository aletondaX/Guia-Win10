...
echo Agregar ubicaciones favoritas al registro
...
echo.
echo Configurar PowerShell en Unrestricted
timeout /t 1 /nobreak >nul
...
echo.
echo Deshabilitar apps en segundo plano
timeout /t 1 /nobreak >nul
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications" /v "GlobalUserDisabled" /t REG_DWORD /d "1" /f
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Search" /v "BackgroundAppGlobalToggle" /t REG_DWORD /d "0" /f
echo.
echo Deshabilitar GameDVR
timeout /t 1 /nobreak >nul
...
echo.
echo Deshabilitar GPU Preemption
timeout /t 1 /nobreak >nul
...
echo.
echo Deshabilitar Spectre y Meltdown
timeout /t 1 /nobreak >nul
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "FeatureSettings" /t REG_DWORD /d "1" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "FeatureSettingsOverride" /t REG_DWORD /d "3" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "FeatureSettingsOverrideMask" /t REG_DWORD /d "3" /f
echo.
echo Tweaks varios para juegos y responsividad del sistema 
timeout /t 1 /nobreak >nul
...
echo.
echo Desactivar notificaciones de seguridad
timeout /t 1 /nobreak >nul
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender Security Center\Notifications" /v "DisableEnhancedNotifications" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender Security Center\Notifications" /v "DisableNotifications" /t REG_DWORD /d "1" /f
If /I %PC%==1 (
echo.
echo Deshabilitar Power Throttling
timeout /t 1 /nobreak >nul
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerThrottling" /v "PowerThrottlingOff" /t REG_DWORD /d "1" /f
echo.
echo Habilitar Task Offloading
